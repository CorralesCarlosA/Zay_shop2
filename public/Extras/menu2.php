...
<head>
    ...
    <link rel="shortcut icon"  href="'frontend/img/icon.ico'; ?>">

    <link rel="stylesheet" href="'frontend/css/estilo0.css'; ?>">
    <link rel="stylesheet" href="'frontend/css/letras.css'; ?>">
    <!--script-->
     <script src="'frontend/js/sweetalert.js'; ?>"></script>
     <script src="'frontend/js/sweet_alerts.js'; ?>"></script>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a style="margin-left: 250px;" class="nav-link" href="mostrar-productos">INICIO</a>
                        </li>

                         <li class="nav-item">
                            <a style="margin-left: 350px; margin-top: -40px;" class="nav-link" href="productos">PRODUCTOS</a>
                        </li>   
...
<!--Nombre y foto de usuario-->
    ...
    <a style="margin-right: 150x;" class="nav-item nav-link active">BIENVENIDO: <?php echo @$nombre_user_sesion; ?></a></div>                        
    <?php endif;?>
<!--menu de salir-->                        
<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in">
<a class="nav-link"  href="'cerrar-session'; ?>">Cerrar sesión</a>
</div>
